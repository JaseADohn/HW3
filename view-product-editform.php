...
<!-- Modal -->
<div class="modal fade" id="editProductModal<?php echo $user['user_id']; ?>" tabindex="-1" aria-labelledby="editProductModalLabel<?php echo $product['product_id']; ?>" aria-hidden="true">
